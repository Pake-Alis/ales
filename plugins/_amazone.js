...
if (Config.WORKTYPE == 'private') {
    ...
    amazone.addCommand({pattern: 'alis ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
...
async function checkImAdmin(message, user = message.client.user.jid) {
    ...
    return sonuc.includes(true);
     ...
     amazone.addCommand({pattern: 'alis ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
